...
void plot_r42_cbwc_significance_muB(){
  ...
  TGraphErrors* tg2 = new TGraphErrors(5, FXT_CBWC_R42_muB, FXT_signif, FXT_CBWC_R42_ex, FXT_CBWC_R42_ex); 
  TGraphErrors* tg3 = new TGraphErrors(5, FXT_CBWC_R42_muB, FXT_signif, FXT_CBWC_R42_ex, FXT_CBWC_R42_ex);
  TGraphErrors* tg4 = new TGraphErrors(5, FXT_CBWC_R42_muB, FXT_signif, FXT_CBWC_R42_ex, FXT_CBWC_R42_ex);
  ...
  TGraphErrors* tcoll2 = new TGraphErrors(9, Coll_CBWC_R42_muB, Coll_signif, Coll_CBWC_R42_ex, Coll_CBWC_R42_ex);
  TGraphErrors* tcoll3 = new TGraphErrors(9, Coll_CBWC_R42_muB, Coll_signif, Coll_CBWC_R42_ex, Coll_CBWC_R42_ex);
  TGraphErrors* tcoll4 = new TGraphErrors(9, Coll_CBWC_R42_muB, Coll_signif, Coll_CBWC_R42_ex, Coll_CBWC_R42_ex);
  ...
  gPad->SetTicks(1,1);
  TH1D* h1 = (TH1D*) gPad->DrawFrame(xl1, -5.3, xl2, 2.85);
  ...
  wb2->SetFillColor(0);
  //wb2->Draw();
  lax.DrawLatex(0.60,0.400,"#frac{#frac{C_{4}}{C_{2}}^{Data} #minus #frac{C_{4}}{C_{2}}^{UrQMD}}{#sigma_{total}}");

  cas->Print("Fig_R42_CBWC_Significance_muB.pdf");
}
