...
void plot_r42_method2_significance(){
  ...
  TGraphErrors* tcoll4 = new TGraphErrors(9, Coll_CBWC_R42_x, Coll_signif, Coll_CBWC_R42_ex, Coll_CBWC_R42_ex);
  ...
  cas->Print("Fig_R42_Method2_Significance.pdf");
}
