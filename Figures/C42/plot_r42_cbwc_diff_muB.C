...
void plot_r42_cbwc_diff_muB(){
  ...
  TGraphErrors* tg2 = new TGraphErrors(5, FXT_CBWC_muB, FXT_diff, FXT_CBWC_XError, FXT_diff_stat);
  TGraphErrors* tg3 = new TGraphErrors(5, FXT_CBWC_muB, FXT_diff, FXT_CBWC_XError, FXT_CBWC_XError);
  TGraphErrors* tg4 = new TGraphErrors(5, FXT_CBWC_muB, FXT_diff, FXT_CBWC_XError, FXT_diff_sys);
  ...
  TGraphErrors* tcoll2 = new TGraphErrors(9, Coll_CBWC_muB, Coll_diff, dummy_ex, Coll_diff_stat);
  TGraphErrors* tcoll3 = new TGraphErrors(9, Coll_CBWC_muB, Coll_diff, dummy_ex, dummy_ex);
  TGraphErrors* tcoll4 = new TGraphErrors(9, Coll_CBWC_muB, Coll_diff, dummy_ex, Coll_diff_sys);
 ...
 //UrQMD (0-5%) - UrQMD (50-60%)
  ...
  TGraphErrors* tg_base = new TGraphErrors(6, UrQMD_FXT_CBWC_muB, FXT_UrQMD_base_diff, FXT_UrQMD_base_ex, FXT_UrQMD_base_diff_stat);
  ...
  TMarker *tm1  = new TMarker(100.4,-8.0,21);
  TMarker *tm2  = new TMarker(100.4,-8.0,25);
  TMarker *tm22 = new TMarker(100.4,-8.0,25);
  ...
  TMarker *tm3  = new TMarker(94.4,-9.3,24);
  tm3->SetMarkerColor(4);
  //tm3->Draw();
  TMarker *tm31 = new TMarker(100.4,-9.3,25);
  ...
  lax.DrawLatex(0.28,0.320,"[C_{4}/C_{2}]^{Data}_{0-5%} - [C_{4}/C_{2}]^{UrQMD}_{0-5%}");
  //lax.DrawLatex(0.68,0.740,"[C_{4}/C_{2}]^{Data}_{0-5%} - [C_{4}/C_{2}]^{Data}_{50-60%}");
  lax.DrawLatex(0.28,0.240,"[C_{4}/C_{2}]^{UrQMD}_{0-5%} - [C_{4}/C_{2}]^{UrQMD}_{40-50%}");
