...
void plot_C42_method2_diff_energy(){
  ...
  TGraphErrors* tg_coll1 = new TGraphErrors(9, cEnergies, Coll_diff, dummy_ex, Coll_diff_stat);
  TGraphErrors* tg_coll2 = new TGraphErrors(9, cEnergies, Coll_diff, dummy_ex, dummy_ex);
  TGraphErrors* tg_coll3 = new TGraphErrors(9, cEnergies, Coll_diff, dummy_ex, Coll_diff_sys); 
  ...
  TGraphErrors* tg_fxt1 = new TGraphErrors(6, FXT_Method2_R42_x, FXT_diff, FXT_Method2_R42_ex, FXT_diff_stat);
  TGraphErrors* tg_fxt2 = new TGraphErrors(6, FXT_Method2_R42_x, FXT_diff, FXT_Method2_R42_ex, FXT_Method2_R42_ex);
  TGraphErrors* tg_fxt3 = new TGraphErrors(6, FXT_Method2_R42_x, FXT_diff, FXT_Method2_R42_ex, FXT_diff_sys);
  ...
  TMarker *tm1  = new TMarker(16.4,0.76,20);
  TMarker *tm2  = new TMarker(16.4,0.76,24);
  TMarker *tm22 = new TMarker(16.4,0.76,24);
  ...
  lax.DrawLatex(0.68,0.784,"[C_{4}/C_{2}]^{Data}_{0-5%} - [C_{4}/C_{2}]^{UrQMD}_{0-5%}");

  cas->Print("Fig_C42_Method2_diff_energy.pdf");
}
