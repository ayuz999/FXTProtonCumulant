...
//0-5% 
void plot_AllRatios_CBWC_diff_energy(){
  ...
  for(int icum=0;icum<6;++icum){
    tg1[icum]     = new TGraphErrors(6, FXT_CBWC_Energy, FXT_diff1[icum], dummy_ex6, FXT_diff1_stat[icum]);
    tg1_sys[icum] = new TGraphErrors(6, FXT_CBWC_Energy, FXT_diff1[icum], dummy_ex6, FXT_diff1_sys[icum]);
    tg2[icum]     = new TGraphErrors(6, FXT_CBWC_Energy, FXT_diff2[icum], dummy_ex6, FXT_diff2_stat[icum]);
    tg2_sys[icum] = new TGraphErrors(6, FXT_CBWC_Energy, FXT_diff2[icum], dummy_ex6, FXT_diff2_sys[icum]);
    tg3[icum]     = new TGraphErrors(6, FXT_CBWC_Energy, FXT_diff3[icum], dummy_ex6, FXT_diff3_stat[icum]);
    tg3_sys[icum] = new TGraphErrors(6, FXT_CBWC_Energy, FXT_diff3[icum], dummy_ex6, FXT_diff3_sys[icum]);
  ...
  cas->Print("Fig_AllRatios_CBWC_diff_energy.pdf");
}
