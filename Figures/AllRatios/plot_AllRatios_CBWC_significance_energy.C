...
//0-5% 
void plot_AllRatios_CBWC_significance_energy(){
  ...
  double FXT_diff1_tot [6][6];
  double FXT_signif1   [6][6];
  double FXT_diff2_tot [6][6];
  double FXT_signif2   [6][6];
  double FXT_diff3_tot [6][6];
  double FXT_signif3   [6][6];
  ...
  for(int ierg=0;ierg<6;++ierg){
    FXT_diff2     [0][ierg] =          FXT_CBWC_R21_Cent05[ierg]            -     FXT_CBWC_R21_Cent5060[ierg];
    FXT_diff2_stat[0][ierg] = sqrt(pow(FXT_CBWC_R21_Cent05_stat[ierg], 2.)  + pow(FXT_CBWC_R21_Cent5060_stat[ierg] ,2.) );
    FXT_diff2_sys [0][ierg] = sqrt(pow(FXT_CBWC_R21_Cent05_sys[ierg],  2.)  + pow(FXT_CBWC_R21_Cent5060_sys[ierg], 2.) ); 
    FXT_diff2     [1][ierg] =          FXT_CBWC_R31_Cent05[ierg]            -     FXT_CBWC_R31_Cent5060[ierg];
    FXT_diff2_stat[1][ierg] = sqrt(pow(FXT_CBWC_R31_Cent05_stat[ierg], 2.)  + pow(FXT_CBWC_R31_Cent5060_stat[ierg] ,2.) );
    FXT_diff2_sys [1][ierg] = sqrt(pow(FXT_CBWC_R31_Cent05_sys[ierg],  2.)  + pow(FXT_CBWC_R31_Cent5060_sys[ierg], 2.) ); 
    FXT_diff2     [2][ierg] =          FXT_CBWC_R42_Cent05[ierg]            -     FXT_CBWC_R42_Cent5060[ierg];
    FXT_diff2_stat[2][ierg] = sqrt(pow(FXT_CBWC_R42_Cent05_stat[ierg], 2.)  + pow(FXT_CBWC_R42_Cent5060_stat[ierg] ,2.) );
    FXT_diff2_sys [2][ierg] = sqrt(pow(FXT_CBWC_R42_Cent05_sys[ierg],  2.)  + pow(FXT_CBWC_R42_Cent5060_sys[ierg], 2.) ); 
    FXT_diff2     [3][ierg] =          FXT_CBWC_FC21_Cent05[ierg]           -     FXT_CBWC_FC21_Cent5060[ierg];
    FXT_diff2_stat[3][ierg] = sqrt(pow(FXT_CBWC_FC21_Cent05_stat[ierg], 2.) + pow(FXT_CBWC_FC21_Cent5060_stat[ierg] ,2.) );
    FXT_diff2_sys [3][ierg] = sqrt(pow(FXT_CBWC_FC21_Cent05_sys[ierg],  2.) + pow(FXT_CBWC_FC21_Cent5060_sys[ierg], 2.) ); 
    FXT_diff2     [4][ierg] =          FXT_CBWC_FC31_Cent05[ierg]           -     FXT_CBWC_FC31_Cent5060[ierg];
    FXT_diff2_stat[4][ierg] = sqrt(pow(FXT_CBWC_FC31_Cent05_stat[ierg], 2.) + pow(FXT_CBWC_FC31_Cent5060_stat[ierg] ,2.) );
    FXT_diff2_sys [4][ierg] = sqrt(pow(FXT_CBWC_FC31_Cent05_sys[ierg],  2.) + pow(FXT_CBWC_FC31_Cent5060_sys[ierg], 2.) ); 
    FXT_diff2     [5][ierg] =          FXT_CBWC_FC41_Cent05[ierg]           -     FXT_CBWC_FC41_Cent5060[ierg];
  ...
  for(int ierg=0;ierg<6;++ierg){
    FXT_diff3     [0][ierg] =          FXT_CBWC_R21_Cent5060[ierg]            -     UrQMD_FXT_CBWC_GapON_HY5_R21_Cent5060[ierg];
    FXT_diff3_stat[0][ierg] = sqrt(pow(FXT_CBWC_R21_Cent5060_stat[ierg], 2.)  + pow(UrQMD_FXT_CBWC_GapON_HY5_R21_Cent5060_stat[ierg] ,2.) );
    FXT_diff3_sys [0][ierg] =          FXT_CBWC_R21_Cent5060_sys[ierg];
    FXT_diff3     [1][ierg] =          FXT_CBWC_R31_Cent5060[ierg]            -     UrQMD_FXT_CBWC_GapON_HY5_R31_Cent5060[ierg];
    FXT_diff3_stat[1][ierg] = sqrt(pow(FXT_CBWC_R31_Cent5060_stat[ierg], 2.)  + pow(UrQMD_FXT_CBWC_GapON_HY5_R31_Cent5060_stat[ierg] ,2.) );
    FXT_diff3_sys [1][ierg] =          FXT_CBWC_R31_Cent5060_sys[ierg];
    FXT_diff3     [2][ierg] =          FXT_CBWC_R42_Cent5060[ierg]            -     UrQMD_FXT_CBWC_GapON_HY5_R42_Cent5060[ierg];
    FXT_diff3_stat[2][ierg] = sqrt(pow(FXT_CBWC_R42_Cent5060_stat[ierg], 2.)  + pow(UrQMD_FXT_CBWC_GapON_HY5_R42_Cent5060_stat[ierg] ,2.) );
    FXT_diff3_sys [2][ierg] =          FXT_CBWC_R42_Cent5060_sys[ierg];
    FXT_diff3     [3][ierg] =          FXT_CBWC_FC21_Cent5060[ierg]           -     UrQMD_FXT_CBWC_GapON_HY5_FC21_Cent5060[ierg];
    FXT_diff3_stat[3][ierg] = sqrt(pow(FXT_CBWC_FC21_Cent5060_stat[ierg], 2.) + pow(UrQMD_FXT_CBWC_GapON_HY5_FC21_Cent5060_stat[ierg] ,2.) );
    FXT_diff3_sys [3][ierg] =          FXT_CBWC_FC21_Cent5060_sys[ierg];
    FXT_diff3     [4][ierg] =          FXT_CBWC_FC31_Cent5060[ierg]           -     UrQMD_FXT_CBWC_GapON_HY5_FC31_Cent5060[ierg];
    FXT_diff3_stat[4][ierg] = sqrt(pow(FXT_CBWC_FC31_Cent5060_stat[ierg], 2.) + pow(UrQMD_FXT_CBWC_GapON_HY5_FC31_Cent5060_stat[ierg] ,2.) );
    FXT_diff3_sys [4][ierg] =          FXT_CBWC_FC31_Cent5060_sys[ierg];
    FXT_diff3     [5][ierg] =          FXT_CBWC_FC41_Cent5060[ierg]           -     UrQMD_FXT_CBWC_GapON_HY5_FC41_Cent5060[ierg];
    FXT_diff3_stat[5][ierg] = sqrt(pow(FXT_CBWC_FC41_Cent5060_stat[ierg], 2.) + pow(UrQMD_FXT_CBWC_GapON_HY5_FC41_Cent5060_stat[ierg] ,2.) );
    FXT_diff3_sys [5][ierg] =          FXT_CBWC_FC41_Cent5060_sys[ierg];
  }

  for(int ierg=0;ierg<6;++ierg){
    for(int icum=0;icum<6;++icum){
      FXT_diff1_tot[icum][ierg] = sqrt(pow(FXT_diff1_stat[icum][ierg], 2.) + pow(FXT_diff1_sys[icum][ierg], 2.));
      FXT_signif1  [icum][ierg] = FXT_diff1[icum][ierg] / FXT_diff1_tot[icum][ierg];
      FXT_diff2_tot[icum][ierg] = sqrt(pow(FXT_diff2_stat[icum][ierg], 2.) + pow(FXT_diff2_sys[icum][ierg], 2.));
      FXT_signif2  [icum][ierg] = FXT_diff2[icum][ierg] / FXT_diff2_tot[icum][ierg];
      FXT_diff3_tot[icum][ierg] = sqrt(pow(FXT_diff3_stat[icum][ierg], 2.) + pow(FXT_diff3_sys[icum][ierg], 2.));
  ...
  for(int icum=0;icum<6;++icum){
    tg1[icum]     = new TGraphErrors(6, FXT_CBWC_Energy, FXT_signif1[icum], dummy_ex6, dummy_ex6);
    tg1_sys[icum] = new TGraphErrors(6, FXT_CBWC_Energy, FXT_signif1[icum], dummy_ex6, dummy_ex6);
    tg2[icum]     = new TGraphErrors(6, FXT_CBWC_Energy, FXT_signif2[icum], dummy_ex6, dummy_ex6);
    tg2_sys[icum] = new TGraphErrors(6, FXT_CBWC_Energy, FXT_signif2[icum], dummy_ex6, dummy_ex6);
    tg3[icum]     = new TGraphErrors(6, FXT_CBWC_Energy, FXT_signif3[icum], dummy_ex6, dummy_ex6);
    tg3_sys[icum] = new TGraphErrors(6, FXT_CBWC_Energy, FXT_signif3[icum], dummy_ex6, dummy_ex6);
  ...
  double Coll_diff1_tot[6][7];
  double Coll_signif1[6][7];
  double Coll_diff2_tot[6][7];
  double Coll_signif2[6][7];
  double Coll_diff3_tot[6][7];
  double Coll_signif3[6][7];
  ...
  for(int ierg=0;ierg<7;++ierg){
    for(int icum=0;icum<6;++icum){
      Coll_diff1_tot[icum][ierg] = sqrt(pow(Coll_diff1_stat[icum][ierg], 2.) + pow(Coll_diff1_sys[icum][ierg], 2.));
      Coll_signif1  [icum][ierg] = Coll_diff1[icum][ierg] / Coll_diff1_tot[icum][ierg];
      Coll_diff2_tot[icum][ierg] = sqrt(pow(Coll_diff2_stat[icum][ierg], 2.) + pow(Coll_diff2_sys[icum][ierg], 2.));
      Coll_signif2  [icum][ierg] = Coll_diff2[icum][ierg] / Coll_diff2_tot[icum][ierg];
      Coll_diff3_tot[icum][ierg] = sqrt(pow(Coll_diff3_stat[icum][ierg], 2.) + pow(Coll_diff3_sys[icum][ierg], 2.));
      Coll_signif3  [icum][ierg] = Coll_diff3[icum][ierg] / Coll_diff3_tot[icum][ierg];
    }
  }
  ...
  for(int icum=0;icum<6;++icum){
    tg4[icum]     = new TGraphErrors(7, Coll_Energies, Coll_signif1[icum], dummy_ex7, dummy_ex7);
    tg5[icum]     = new TGraphErrors(7, Coll_Energies, Coll_signif2[icum], dummy_ex7, dummy_ex7);
    tg6[icum]     = new TGraphErrors(7, Coll_Energies, Coll_signif3[icum], dummy_ex7, dummy_ex7);
  ...
  gPad->SetRightMargin(0.03);
  gPad->SetTicks(1,1);
  TH1D* h2 = (TH1D*)gPad->DrawFrame(x1, -27.66, x2, 12.28);
  ...
  gPad->SetLeftMargin(0.12);
  gPad->SetRightMargin(0.03);
  TH1D* h3 = (TH1D*)gPad->DrawFrame(x1, -31.6, x2, 8.2);
  ...
  gPad->SetLeftMargin(0.12);
  gPad->SetRightMargin(0.03);
  TH1D* h5 = (TH1D*)gPad->DrawFrame(x1, -4.22, x2, 16.12);
  ...
  lax.SetTextColor(1);
  lax.SetTextColor(4);
  lax.DrawLatex(0.170,0.890,"CBWC");
  ...
  cas->Print("Fig_AllRatios_CBWC_significance_energy.pdf");
}
