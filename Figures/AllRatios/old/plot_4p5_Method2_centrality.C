...
void plot_4p5_Method2_centrality(){
  ...
  tg1[0]      = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_R21,  dummy_ex, FXT_Method2_4p5_R21_stat);
  tg1_sys[0]  = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_R21,  dummy_ex, FXT_Method2_4p5_R21_sys);
  tg1_prof[0] = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_R21,  dummy_ex, dummy_ex);
  tg1[1]      = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_R31,  dummy_ex, FXT_Method2_4p5_R31_stat);
  tg1_sys[1]  = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_R31,  dummy_ex, FXT_Method2_4p5_R31_sys);
  tg1_prof[1] = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_R31,  dummy_ex, dummy_ex);
  tg1[2]      = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_R42,  dummy_ex, FXT_Method2_4p5_R42_stat);
  tg1_sys[2]  = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_R42,  dummy_ex, FXT_Method2_4p5_R42_sys);
  tg1_prof[2] = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_R42,  dummy_ex, dummy_ex);
  tg1[3]      = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_FC21, dummy_ex, FXT_Method2_4p5_FC21_stat);
  tg1_sys[3]  = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_FC21, dummy_ex, FXT_Method2_4p5_FC21_sys);
  tg1_prof[3] = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_FC21, dummy_ex, dummy_ex);
  tg1[4]      = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_FC31, dummy_ex, FXT_Method2_4p5_FC31_stat);
  tg1_sys[4]  = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_FC31, dummy_ex, FXT_Method2_4p5_FC31_sys);
  tg1_prof[4] = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_FC31, dummy_ex, dummy_ex);
  tg1[5]      = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_FC41, dummy_ex, FXT_Method2_4p5_FC41_stat);
  tg1_sys[5]  = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_FC41, dummy_ex, FXT_Method2_4p5_FC41_sys);
  tg1_prof[5] = new TGraphErrors(6, FXT_Method2_4p5_Npart, FXT_Method2_4p5_FC41, dummy_ex, dummy_ex);
  ...
  //UrQMD, FXT, method 2
  TGraphErrors* tg2[6];
  tg2[0] = new TGraphErrors(6, FXT_Method2_4p5_Npart, UrQMD_Method2_4p5_R21,  dummy_ex, UrQMD_Method2_4p5_R21_stat);
  tg2[1] = new TGraphErrors(6, FXT_Method2_4p5_Npart, UrQMD_Method2_4p5_R31,  dummy_ex, UrQMD_Method2_4p5_R31_stat);
  tg2[2] = new TGraphErrors(6, FXT_Method2_4p5_Npart, UrQMD_Method2_4p5_R42,  dummy_ex, UrQMD_Method2_4p5_R42_stat);
  tg2[3] = new TGraphErrors(6, FXT_Method2_4p5_Npart, UrQMD_Method2_4p5_FC21, dummy_ex, UrQMD_Method2_4p5_FC21_stat);
  tg2[4] = new TGraphErrors(6, FXT_Method2_4p5_Npart, UrQMD_Method2_4p5_FC31, dummy_ex, UrQMD_Method2_4p5_FC31_stat);
  tg2[5] = new TGraphErrors(6, FXT_Method2_4p5_Npart, UrQMD_Method2_4p5_FC41, dummy_ex, UrQMD_Method2_4p5_FC41_stat);
  for(int i=0;i<6;++i){
  ...
  lax.SetTextColor(1);
  lax.SetTextColor(4);
  lax.DrawLatex(0.112,0.880,"Method 2, 4.5 GeV");
  lax.SetTextColor(1);
  lax.SetTextColor(1);
