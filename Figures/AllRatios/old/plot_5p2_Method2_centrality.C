...
void plot_5p2_Method2_centrality(){
  ...
  tg1[0]      = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_R21,  dummy_ex, FXT_Method2_5p2_R21_stat);
  tg1_sys[0]  = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_R21,  dummy_ex, FXT_Method2_5p2_R21_sys);
  tg1_prof[0] = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_R21,  dummy_ex, dummy_ex);
  tg1[1]      = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_R31,  dummy_ex, FXT_Method2_5p2_R31_stat);
  tg1_sys[1]  = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_R31,  dummy_ex, FXT_Method2_5p2_R31_sys);
  tg1_prof[1] = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_R31,  dummy_ex, dummy_ex);
  tg1[2]      = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_R42,  dummy_ex, FXT_Method2_5p2_R42_stat);
  tg1_sys[2]  = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_R42,  dummy_ex, FXT_Method2_5p2_R42_sys);
  tg1_prof[2] = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_R42,  dummy_ex, dummy_ex);
  tg1[3]      = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_FC21, dummy_ex, FXT_Method2_5p2_FC21_stat);
  tg1_sys[3]  = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_FC21, dummy_ex, FXT_Method2_5p2_FC21_sys);
  tg1_prof[3] = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_FC21, dummy_ex, dummy_ex);
  tg1[4]      = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_FC31, dummy_ex, FXT_Method2_5p2_FC31_stat);
  tg1_sys[4]  = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_FC31, dummy_ex, FXT_Method2_5p2_FC31_sys);
  tg1_prof[4] = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_FC31, dummy_ex, dummy_ex);
  tg1[5]      = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_FC41, dummy_ex, FXT_Method2_5p2_FC41_stat);
  tg1_sys[5]  = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_FC41, dummy_ex, FXT_Method2_5p2_FC41_sys);
  tg1_prof[5] = new TGraphErrors(6, FXT_Method2_5p2_Npart, FXT_Method2_5p2_FC41, dummy_ex, dummy_ex);
  ...
  //UrQMD, FXT, method 2
  TGraphErrors* tg2[6];
  tg2[0] = new TGraphErrors(6, FXT_Method2_5p2_Npart, UrQMD_Method2_5p2_R21,  dummy_ex, UrQMD_Method2_5p2_R21_stat);
  tg2[1] = new TGraphErrors(6, FXT_Method2_5p2_Npart, UrQMD_Method2_5p2_R31,  dummy_ex, UrQMD_Method2_5p2_R31_stat);
  tg2[2] = new TGraphErrors(6, FXT_Method2_5p2_Npart, UrQMD_Method2_5p2_R42,  dummy_ex, UrQMD_Method2_5p2_R42_stat);
  tg2[3] = new TGraphErrors(6, FXT_Method2_5p2_Npart, UrQMD_Method2_5p2_FC21, dummy_ex, UrQMD_Method2_5p2_FC21_stat);
  tg2[4] = new TGraphErrors(6, FXT_Method2_5p2_Npart, UrQMD_Method2_5p2_FC31, dummy_ex, UrQMD_Method2_5p2_FC31_stat);
  tg2[5] = new TGraphErrors(6, FXT_Method2_5p2_Npart, UrQMD_Method2_5p2_FC41, dummy_ex, UrQMD_Method2_5p2_FC41_stat);
  for(int i=0;i<6;++i){
  ...
  gPad->SetRightMargin(0.03);
  gPad->SetTicks(1,1);
  TH1D* h2 = (TH1D*)gPad->DrawFrame(x1, 0.65, x2, 1.55);
  ...
  gPad->SetRightMargin(0.03);
  gPad->SetTicks(1,1);
  TH1D* h4 = (TH1D*)gPad->DrawFrame(x1, -0.12, x2, 0.18);
  ...
  gPad->SetRightMargin(0.03);
  gPad->SetTicks(1,1);
  TH1D* h6 = (TH1D*)gPad->DrawFrame(x1, -0.18, x2, 0.76);
  ...
  lax.SetTextColor(1);
  lax.SetTextColor(4);
  lax.DrawLatex(0.112,0.880,"Method 2, 5.2 GeV");
  lax.SetTextColor(1);
  lax.SetTextColor(1);
