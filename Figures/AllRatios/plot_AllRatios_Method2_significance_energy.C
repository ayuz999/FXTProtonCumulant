...
//0-5% 
void plot_AllRatios_Method2_significance_energy(){
  ...
  for(int icum=0;icum<6;++icum){
    tg1[icum]     = new TGraphErrors(6, FXT_Method2_Energy, FXT_signif1[icum], dummy_ex6, dummy_ex6);
    tg1_sys[icum] = new TGraphErrors(6, FXT_Method2_Energy, FXT_signif1[icum], dummy_ex6, dummy_ex6);
    tg2[icum]     = new TGraphErrors(6, FXT_Method2_Energy, FXT_signif2[icum], dummy_ex6, dummy_ex6);
    tg2_sys[icum] = new TGraphErrors(6, FXT_Method2_Energy, FXT_signif2[icum], dummy_ex6, dummy_ex6);
    tg3[icum]     = new TGraphErrors(6, FXT_Method2_Energy, FXT_signif3[icum], dummy_ex6, dummy_ex6);
    tg3_sys[icum] = new TGraphErrors(6, FXT_Method2_Energy, FXT_signif3[icum], dummy_ex6, dummy_ex6);
  ...
  TH1D* h1 = (TH1D*)gPad->DrawFrame(x1, -16.22, x2, 21.17);
  ...
  gPad->SetLeftMargin(0.12);
  gPad->SetRightMargin(0.03);
  TH1D* h3 = (TH1D*)gPad->DrawFrame(x1, -27.6, x2, 12.2);
  ...
  gPad->SetRightMargin(0.03);
  gPad->SetTicks(1,1);
  TH1D* h4 = (TH1D*)gPad->DrawFrame(x1, -33.22, x2, 15.22);
  ...
  cas->Print("Fig_AllRatios_Method2_significance_energy.pdf");
}
